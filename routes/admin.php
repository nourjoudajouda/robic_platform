...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('GoldHistoryController')->name('gold.history.')->prefix('gold-history')->group(function () {
        ...
        Route::post('redeem/status/{id}/{status}', 'redeemStatus')->name('redeem.status');
    });
    ...
    Route::controller('HistoricalPriceController')->name('historical.price.')->prefix('historical-price')->group(function () {
        Route::get('/', 'list')->name('list');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('delete/{id}', 'delete')->name('delete');
    });

    Route::controller('PriceApiController')->name('price.api.')->prefix('api')->group(function () {
        Route::get('list', 'list')->name('list');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
    });

    Route::controller('RedeemUnitController')->name('redeem.unit.')->prefix('redeem/unit')->group(function () {
        Route::get('list', 'list')->name('list');
        Route::post('save/{id?}', 'save')->name('save');
        Route::post('status/{id}', 'status')->name('status');
    });    
