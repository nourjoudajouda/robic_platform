    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::middleware(['check.status'])->group(function () {
            ...
            Route::middleware('registration.complete')->group(function () {
                ...
                Route::controller('BuyController')->prefix('buy')->group(function () {
                    Route::get('history', 'buyHistory');
                    Route::get('form', 'buyForm');
                    Route::post('save', 'buySave');
                });

                Route::controller('SellController')->prefix('sell')->group(function () {
                    Route::get('history', 'sellHistory');
                    Route::get('form', 'sellForm');
                    Route::post('save', 'sellSave');
                });

                Route::controller('RedeemController')->prefix('redeem')->group(function () {
                    Route::get('history', 'redeemHistory');
                    Route::get('form', 'redeemForm');
                    Route::post('save', 'redeemSave');
                });

                Route::controller('GiftController')->prefix('gift')->group(function () {
                    Route::get('history', 'giftHistory');
                    Route::get('form', 'giftForm');
                    Route::post('save', 'giftSave');
                    Route::post('check-recipient', 'checkRecipient');
                });
