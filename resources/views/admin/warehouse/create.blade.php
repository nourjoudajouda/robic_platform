                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location_en" class="form-control" value="{{ old('location_en') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manager_name_en" class="form-control" value="{{ old('manager_name_en') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Manager Name') (@lang('Arabic')) <span class="text--danger">*</span></label>
                                    <input type="text" name="manager_name_ar" class="form-control" value="{{ old('manager_name_ar') }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00000001" name="latitude" class="form-control" value="{{ old('latitude') }}" placeholder="24.7136">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.00000001" name="longitude" class="form-control" value="{{ old('longitude') }}" placeholder="46.6753">
