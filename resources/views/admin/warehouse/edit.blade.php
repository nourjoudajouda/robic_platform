                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $warehouse->code }}" disabled>
                                    <small class="form-text text-muted">@lang('Code cannot be modified')</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" class="form-control" value="{{ old('mobile', $warehouse->mobile) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Max Capacity Unit')</label>
                                    <input type="text" name="max_capacity_unit" class="form-control" value="{{ old('max_capacity_unit', $warehouse->max_capacity_unit) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Max Capacity (KG)')</label>
                                    <input type="number" step="0.01" name="max_capacity_kg" class="form-control" value="{{ old('max_capacity_kg', $warehouse->max_capacity_kg) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" required>
                                        <option value="1" {{ old('status', $warehouse->status) == 1 ? 'selected' : '' }}>@lang('Active')</option>
                                        <option value="0" {{ old('status', $warehouse->status) == 0 ? 'selected' : '' }}>@lang('Not Active')</option>
                                    </select>
                                </div>
                            </div>
                        </div>
