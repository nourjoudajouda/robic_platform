                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" name="units_count" id="units_count" class="form-control" value="{{ old('units_count') }}" required style="flex: 1;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" name="sell_price" id="sell_price" class="form-control" value="{{ old('sell_price') }}" required style="flex: 1;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">@lang('Batch code will be generated automatically in format: BT-XXX')</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="quality_grade" class="form-control" id="quality_grade_select">
                                        ...
                                        <option value="Premium" {{ old('quality_grade') == 'Premium' ? 'selected' : '' }}>@lang('Premium') (90-100)</option>
                                        <option value="Excellent" {{ old('quality_grade') == 'Excellent' ? 'selected' : '' }}>@lang('Excellent') (85-89.9)</option>
                                        <option value="Very Good" {{ old('quality_grade') == 'Very Good' ? 'selected' : '' }}>@lang('Very Good') (80-84.9)</option>
                                        <option value="Grade 1" {{ old('quality_grade') == 'Grade 1' ? 'selected' : '' }}>@lang('Grade 1') / @lang('Grade A')</option>
                                        <option value="Grade 2" {{ old('quality_grade') == 'Grade 2' ? 'selected' : '' }}>@lang('Grade 2') / @lang('Grade B')</option>
                                        <option value="Grade 3" {{ old('quality_grade') == 'Grade 3' ? 'selected' : '' }}>@lang('Grade 3') / @lang('Grade C')</option>
                                        <option value="Commercial" {{ old('quality_grade') == 'Commercial' ? 'selected' : '' }}>@lang('Commercial Grade')</option>
                                        <option value="Other" {{ old('quality_grade') == 'Other' ? 'selected' : '' }}>@lang('Other')</option>
                                    </select>
                                    <input type="text" name="quality_grade_custom" id="quality_grade_custom" class="form-control mt-2" value="{{ old('quality_grade_custom') }}" placeholder="@lang('Enter custom quality grade')" style="display: none;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="origin_country" class="form-control" value="{{ old('origin_country') }}" placeholder="@lang('e.g., Ethiopia, Colombia, etc.')">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="buy_price" id="buy_price" class="form-control" value="{{ old('buy_price') }}">
                                </div>
                            </div>
    ...
    (function($) {
        ...
        function updateProductInfo() {
            ...
            if (productId) {
                ...
                const unitSymbol = option.data('unit-symbol') || '@lang("Unit")';
                const currencySymbol = option.data('currency-symbol') || '@lang("Currency")';
