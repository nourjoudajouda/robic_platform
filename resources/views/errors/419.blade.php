...
<head>
    ...
    <title>419 - {{ gs()->siteName(__('Session has expired')) }}</title>
...
<body>
    ...
    <div class="error-container" style="position: relative; z-index: 1;">
        ...
        <h1 class="error-title">@lang('انتهت الجلسة')</h1>
        
        <p class="error-description">
            @lang('عذراً، انتهت صلاحية الجلسة الخاصة بك.')<br>
            @lang('يرجى العودة للخلف وتحديث الصفحة والمحاولة مرة أخرى.')
        </p>
