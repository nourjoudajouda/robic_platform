            ...
            <div class="card custom--card">
                <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    @if ($myTicket->status != Status::TICKET_CLOSE && $myTicket->user)
                        <button class="btn btn--danger text-white close-button btn--sm confirmationBtn" type="button" data-question="@lang('Are you sure to close this ticket?')" data-action="{{ route('ticket.close', $myTicket->id) }}"><i class="fas fa-lg fa-times-circle"></i>
                        </button>
                    @endif
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    @forelse($messages as $message)
                        @if ($message->admin_id == 0)
                            <div class="row border border-primary rounded-3 my-3 py-3 mx-2">
                                <div class="col-md-3 border-end border-primary text-end">
                        ...
                        @else
                            <div class="row border border-warning rounded-3 my-3 py-3 mx-2 reply-bg">
                                <div class="col-md-3 border-end border-warning text-end">
