...
<head>
    ...
    <title>التحقق من رقم الهاتف - روبيك</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-7 col-sm-9">
                        <div class="otp-card">
                            ...
                            <!-- Title -->
                            <h2 class="otp-title">@lang('Verify Mobile Number')</h2>
                            ...
                            <form action="{{ route('user.verify.mobile') }}" method="POST" class="submit-form">
                                ...
                                <div class="otp-input-group">
                                    ...
                                    <div class="otp-timer">
                                        ...
                                        <a href="{{ route('user.send.verify.code', 'sms') }}" class="resend-link try-again-link d-none">@lang('Try again')</a>
                                    </div>
                                </div>
