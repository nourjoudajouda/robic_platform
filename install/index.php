...
if ($action == 'result') {
	...
	$result = curl_exec($ch);
	curl_close($ch);
	$response = array('error' => 'ok', 'message' => 'Valid license! DoniaWeB');
	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<h3 class="title">Easy Installer | <a style="color:red;" href="https://doniaweb.com" target="_blank">DoniaWeB</a></h3>
			</div>
		</div>
	</header>
